...
func main() {
	...
	r.Post("/users/{id}/pro-upgrade-intent", handlers.PostUserProUpgradeIntent)
	...
	r.Route("/admin", func(r chi.Router) {
		...
		r.Put("/users/{id}/pro", adminHandlers.SetUserPro)
		r.Put("/telegram-users/{telegram_id}/pro", adminHandlers.SetTelegramUserPro)
