...
"${VENV_DIR}/bin/python" -m pip install -r "${BROWSER_DIR}/requirements-dev.txt"

echo ""
echo "browser-service venv is ready: ${VENV_DIR}"
echo "Run unit tests with:"
echo "  ./scripts/pytest_browser_service.sh -q"
